...
function mousePressed() {
  colorCount += 10;
  this.p = new ParticleSystem(createVector(mouseX, mouseY), colorCount);
  systems.push(p);
}
...
Particle.prototype.run = function (colorCount) {
  this.update();
  this.display(colorCount);
};
...
CrazyParticle.prototype.display = function (colorCount) {
